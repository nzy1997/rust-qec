    ...
    for row in sheet_rows:
        ...
        matched.append(
            (
                ...
                row.source_sheet,
                row.source_row,
                row.values["baseline_method"],
                {
                    "case_id": case_id,
                    "paper_case": paper_case,
                    "baseline_method": row.values["baseline_method"],
                    "baseline_upper_bound": row.values["baseline_upper_bound"],
                    "baseline_elapsed_s": row.values["baseline_elapsed_s"],
