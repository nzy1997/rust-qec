...
Measured 2026-09-16T05:07:51Z on `macOS-26.6.2-arm64-arm-64bit-Mach-O` (arm64, 10 CPUs, 32.00 GiB).
Binary `rustqec 0.3.1` sha256 `9edd67c3d7b54517…`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| matching-d3r2-p002-b1024 | envelope-matching | batch-scale | 0.002 | 1024 | 0.01 | 0.001 | 0.00 | 49 | 49 | 975 | 0 | 7.1 MiB |
| matching-d3r2-p002-b16384 | envelope-matching | batch-scale | 0.002 | 16384 | 0.03 | 0.001 | 0.02 | 245 | 245 | 16139 | 0 | 12.8 MiB |
| matching-d3r2-p002-b65536 | envelope-matching | batch-scale | 0.002 | 65536 | 0.08 | 0.001 | 0.07 | 433 | 433 | 65103 | 0 | 16.8 MiB |
| matching-d3r2-p020-b1024 | envelope-matching | batch-scale | 0.02 | 1024 | 0.02 | 0.001 | 0.01 | 598 | 598 | 426 | 0 | 22.0 MiB |
| matching-d3r2-p020-b16384 | envelope-matching | batch-scale | 0.02 | 16384 | 0.16 | 0.001 | 0.14 | 4684 | 7219 | 9165 | 2535 | 41.7 MiB |
| matching-d3r2-p020-b65536 | envelope-matching | batch-scale | 0.02 | 65536 | 0.58 | 0.001 | 0.57 | 11669 | 28107 | 37429 | 16438 | 41.9 MiB |
| matching-d3r2-p100-b1024 | envelope-matching | batch-scale | 0.1 | 1024 | 0.03 | 0.001 | 0.02 | 1024 | 1024 | 0 | 0 | 41.9 MiB |
| matching-d3r2-p100-b16384 | envelope-matching | batch-scale | 0.1 | 16384 | 0.39 | 0.001 | 0.38 | 16244 | 16381 | 3 | 137 | 43.6 MiB |
| matching-d3r2-p100-b65536 | envelope-matching | batch-scale | 0.1 | 65536 | 1.55 | 0.001 | 1.54 | 65536 | 65519 | 17 | 0 | 43.7 MiB |
| matching-d3r3-p020-b16384 | envelope-matching | circuit-scale | 0.02 | 16384 | 0.46 | 0.002 | 0.44 | 9059 | 12326 | 4058 | 3267 | 68.1 MiB |
| matching-d5r3-p020-b16384 | envelope-matching | circuit-scale | 0.02 | 16384 | 1.96 | 0.005 | 1.93 | 16314 | 16384 | 0 | 70 | 201.6 MiB |
| matching-eviction-wires24 | envelope-matching | cache-eviction | synthetic | 1601 | 0.02 | 0.000 | 0.01 | 1401 | 1402 | 199 | 1 | 201.6 MiB |
| mle-d3r2-p002-b1024 | envelope-mle | repeated-patterns | 0.002 | 1024 | 2.28 | 0.003 | 2.27 | 45 | 45 | 979 | 0 | 201.6 MiB |
| mle-d3r2-p002-b16384 | envelope-mle | repeated-patterns | 0.002 | 16384 | 36.76 | 0.003 | 36.74 | 267 | 267 | 16117 | 0 | 201.6 MiB |
| mle-eviction-wires24 | envelope-mle | cache-eviction | synthetic | 1601 | 1.01 | 0.000 | 0.99 | 1401 | 1402 | 199 | 1 | 201.6 MiB |
