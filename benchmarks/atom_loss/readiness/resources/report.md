...
Measured 2026-09-16T05:31:00Z on `macOS-26.6.2-arm64-arm-64bit-Mach-O` (arm64, 10 CPUs, 32.00 GiB).
Binary `rustqec 0.3.2` sha256 `d76ecb152326e157…`.
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| matching-d3r2-p002-b1024 | envelope-matching | batch-scale | 0.002 | 1024 | 0.01 | 0.002 | 0.00 | 49 | 49 | 975 | 0 | 7.3 MiB |
| matching-d3r2-p002-b16384 | envelope-matching | batch-scale | 0.002 | 16384 | 0.03 | 0.001 | 0.02 | 245 | 245 | 16139 | 0 | 12.9 MiB |
| matching-d3r2-p002-b65536 | envelope-matching | batch-scale | 0.002 | 65536 | 0.08 | 0.001 | 0.07 | 433 | 433 | 65103 | 0 | 16.9 MiB |
| matching-d3r2-p020-b1024 | envelope-matching | batch-scale | 0.02 | 1024 | 0.02 | 0.001 | 0.01 | 598 | 598 | 426 | 0 | 22.1 MiB |
| matching-d3r2-p020-b16384 | envelope-matching | batch-scale | 0.02 | 16384 | 0.17 | 0.001 | 0.16 | 4684 | 7219 | 9165 | 2535 | 41.9 MiB |
| matching-d3r2-p020-b65536 | envelope-matching | batch-scale | 0.02 | 65536 | 0.63 | 0.001 | 0.61 | 11669 | 28107 | 37429 | 16438 | 42.1 MiB |
| matching-d3r2-p100-b1024 | envelope-matching | batch-scale | 0.1 | 1024 | 0.04 | 0.002 | 0.03 | 1024 | 1024 | 0 | 0 | 42.1 MiB |
| matching-d3r2-p100-b16384 | envelope-matching | batch-scale | 0.1 | 16384 | 0.44 | 0.001 | 0.42 | 16244 | 16381 | 3 | 137 | 42.4 MiB |
| matching-d3r2-p100-b65536 | envelope-matching | batch-scale | 0.1 | 65536 | 1.86 | 0.001 | 1.85 | 65536 | 65519 | 17 | 0 | 43.8 MiB |
| matching-d3r3-p020-b16384 | envelope-matching | circuit-scale | 0.02 | 16384 | 0.49 | 0.002 | 0.48 | 9059 | 12326 | 4058 | 3267 | 68.7 MiB |
| matching-d5r3-p020-b16384 | envelope-matching | circuit-scale | 0.02 | 16384 | 2.13 | 0.006 | 2.09 | 16314 | 16384 | 0 | 70 | 209.6 MiB |
| matching-eviction-wires24 | envelope-matching | cache-eviction | synthetic | 1601 | 0.02 | 0.000 | 0.01 | 1401 | 1402 | 199 | 1 | 209.6 MiB |
| mle-d3r2-p002-b1024 | envelope-mle | repeated-patterns | 0.002 | 1024 | 2.46 | 0.003 | 2.45 | 45 | 45 | 979 | 0 | 209.6 MiB |
| mle-d3r2-p002-b16384 | envelope-mle | repeated-patterns | 0.002 | 16384 | 40.33 | 0.003 | 40.32 | 267 | 267 | 16117 | 0 | 209.6 MiB |
| mle-eviction-wires24 | envelope-mle | cache-eviction | synthetic | 1601 | 1.17 | 0.000 | 1.13 | 1401 | 1402 | 199 | 1 | 209.6 MiB |
