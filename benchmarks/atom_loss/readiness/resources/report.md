...
Measured 2026-09-15T07:08:53Z on `macOS-26.6.2-arm64-arm-64bit` (arm64, 10 CPUs, 32.00 GiB).
Binary `rustqec 0.3.0` sha256 `287efdf05e908109…`.
...
| matching-d3r2-p002-b16384 | envelope-matching | batch-scale | 0.002 | 16384 | 0.02 | 0.001 | 0.02 | 245 | 245 | 16139 | 0 | 13.1 MiB |
| matching-d3r2-p002-b65536 | envelope-matching | batch-scale | 0.002 | 65536 | 0.08 | 0.002 | 0.07 | 433 | 433 | 65103 | 0 | 17.3 MiB |
| matching-d3r2-p020-b1024 | envelope-matching | batch-scale | 0.02 | 1024 | 0.02 | 0.001 | 0.01 | 598 | 598 | 426 | 0 | 22.3 MiB |
| matching-d3r2-p020-b16384 | envelope-matching | batch-scale | 0.02 | 16384 | 0.15 | 0.001 | 0.14 | 4684 | 7219 | 9165 | 2535 | 42.0 MiB |
| matching-d3r2-p020-b65536 | envelope-matching | batch-scale | 0.02 | 65536 | 0.60 | 0.001 | 0.59 | 11669 | 28107 | 37429 | 16438 | 42.3 MiB |
| matching-d3r2-p100-b1024 | envelope-matching | batch-scale | 0.1 | 1024 | 0.03 | 0.001 | 0.02 | 1024 | 1024 | 0 | 0 | 42.3 MiB |
| matching-d3r2-p100-b16384 | envelope-matching | batch-scale | 0.1 | 16384 | 0.39 | 0.001 | 0.38 | 16244 | 16381 | 3 | 137 | 44.0 MiB |
| matching-d3r2-p100-b65536 | envelope-matching | batch-scale | 0.1 | 65536 | 1.51 | 0.001 | 1.50 | 65536 | 65519 | 17 | 0 | 44.0 MiB |
| matching-d3r3-p020-b16384 | envelope-matching | circuit-scale | 0.02 | 16384 | 0.44 | 0.002 | 0.43 | 9059 | 12326 | 4058 | 3267 | 68.3 MiB |
| matching-d5r3-p020-b16384 | envelope-matching | circuit-scale | 0.02 | 16384 | 1.93 | 0.005 | 1.90 | 16314 | 16384 | 0 | 70 | 204.1 MiB |
| matching-eviction-wires24 | envelope-matching | cache-eviction | synthetic | 1601 | 0.02 | 0.000 | 0.01 | 1401 | 1402 | 199 | 1 | 204.1 MiB |
| mle-d3r2-p002-b1024 | envelope-mle | repeated-patterns | 0.002 | 1024 | 2.15 | 0.003 | 2.14 | 45 | 45 | 979 | 0 | 204.1 MiB |
| mle-d3r2-p002-b16384 | envelope-mle | repeated-patterns | 0.002 | 16384 | 37.54 | 0.003 | 37.53 | 267 | 267 | 16117 | 0 | 204.1 MiB |
| mle-eviction-wires24 | envelope-mle | cache-eviction | synthetic | 1601 | 0.95 | 0.000 | 0.93 | 1401 | 1402 | 199 | 1 | 204.1 MiB |
