...
| --- | --- | --- |
| Maturity | Supported since v0.3.1 (verified by its release evidence bundle) | Supported since v0.3.2 (verified independently by its release evidence bundle and [MLE scope plan](envelope-mle-scope.json)) |
