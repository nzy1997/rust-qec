...
- [ ] **Step 2: Implement public types and validation**
...
- [ ] **Step 3: Implement checked distance math**
...
- [ ] **Step 5: Implement face supports**
...
- [ ] **Step 6: Add module-local constructor tests**
...
- [ ] **Step 7: Verify constructor green locally**
...
- [ ] **Step 1: Extend family contract types**
...
- [ ] **Step 2: Add `construct_css` color branch**
...
- [ ] **Step 5: Extend built-in parser and catalog**
...
- [ ] **Step 6: Update existing tests that enumerate callable IDs and catalog output**
