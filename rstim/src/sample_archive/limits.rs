...
pub struct ArchiveLimits {
    ...
    pub max_compressed_bytes_per_frame: u64,
    pub max_decompressed_bytes_per_frame: u64,
...
impl Default for ArchiveLimits {
    fn default() -> Self {
        Self {
            ...
            max_compressed_bytes_per_frame: 64 * 1024 * 1024,
            max_decompressed_bytes_per_frame: 64 * 1024 * 1024,
...
mod tests {
    ...
    fn archive_defaults_keep_transform_limits_embedded() {
        ...
        assert_eq!(limits.max_archive_bytes, 512 * 1024 * 1024);
        ...
        assert_eq!(limits.max_compressed_bytes_per_frame, 64 * 1024 * 1024);
        assert_eq!(limits.max_decompressed_bytes_per_frame, 64 * 1024 * 1024);
